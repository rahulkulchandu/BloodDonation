...
// echo $data['bgroup'];
$bgroup=$data['bgroup'];
$searchSql="select *from `donorsdetails` where donor_bgroup='$bgroup' and donor_status='active'";
$result=mysqli_query($conn,$searchSql);
$existSearch=mysqli_num_rows($result);
if($existSearch>0){
    ...
    <p class="lead">There are no data found please search another blood group.</p>
    <hr class="my-4">
